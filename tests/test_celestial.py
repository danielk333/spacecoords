...
class TestFrames(unittest.TestCase):
    ...
    def test_ecef_geo_inverse(self):
        ...
        y_ref = celestial.ITRS_to_geodetic(x)
    ...
    def test_ITRS_to_geodetic(self):
        dec = 3
        x = celestial.ITRS_to_geodetic(np.array([0.0, 0.0, constants.WGS84.b]))
        y = np.array((90.0, 0.0, 0.0))
        ...
        x = celestial.ITRS_to_geodetic(np.array([constants.WGS84.a, 0.0, 0.0]))
        y = np.array((0.0, 0.0, 0.0))
        nt.assert_array_almost_equal(x, y, decimal=dec)

        x = celestial.ITRS_to_geodetic(np.array([0.0, constants.WGS84.a, 0.0]))
        y = np.array((0.0, 90.0, 0.0))
        nt.assert_array_almost_equal(x, y, decimal=dec)

        x = celestial.ITRS_to_geodetic(np.array([0.0, 0.0, constants.WGS84.b + 100.0]))
        y = np.array((90.0, 0.0, 100.0))
        nt.assert_array_almost_equal(x, y, decimal=dec)
